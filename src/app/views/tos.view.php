...
<html lang="es">
<head>
    <title>UNLu PAW - Términos y condiciones</title>
    <meta charset="utf-8">
...
<body>
    ...
    <main>
        ...
        <p>Si hay un cambio significativo en los términos de este acuerdo, podemos informarle utilizando la información de contacto que tenemos en nuestra base de datos o mediante una notificación.</p>
        ...
        <ul>
            ...
            <li>
                <section>
                    <h3>Sección 2 - Adhesión junto con la política de privacidad</h3>
                    <p>El uso de este sitio web implica la adhesión a estas Condiciones de Uso y a la versión más actualizada de la Política de Privacidad de UNLu PAW.</p>
                </section>
            </li>
            
            <li>
                <section>
                    <h3>Sección 3 - Condiciones de acceso</h3>
                    <p>En general, el acceso al sitio web de UNLu PAW es gratuito y no requiere registro previo.</p>
                    <p>Sin embargo, para hacer uso de algunas funcionalidades, el usuario puede necesitar registrarse, creando una cuenta de usuario con un nombre de usuario y una contraseña de acceso.</p>
                    <p>Es responsabilidad del usuario proporcionar únicamente información correcta, auténtica, válida, completa y actualizada, así como no revelar su nombre de usuario y contraseña a terceros.</p> 
                    <p>Algunas partes de este sitio web ofrecen al usuario la opción de publicar comentarios en determinadas áreas. UNLu PAW no consiente la publicación de contenidos de carácter discriminatorio, ofensivo o ilícito, o que infrinjan los derechos de autor o cualquier otro derecho de terceros.</p>
                    <p>La publicación de cualquier contenido por parte del usuario de este sitio web, incluidos los mensajes y comentarios, implica una licencia no exclusiva, irrevocable e irreversible para su uso, reproducción y publicación por parte de UNLu PAW en su sitio web, plataformas de internet y aplicaciones, o incluso en otras plataformas, sin ninguna restricción o limitación.</p>
                </section>
            </li>
            
            <li>
                <section>
                    <h3>Sección 4 - Cookies</h3>
            ...
            <li>
                <section>
                    <h3>Sección 5 - Propiedad intelectual</h3>
                    <p>Todos los elementos de UNLu PAW son propiedad intelectual de la misma o de sus licenciantes. Estos términos o el uso del sitio web no le otorgan ninguna licencia o derecho de uso de los derechos de propiedad intelectual de UNLu PAW o de cualquier tercero.</p>
                </section>
            </li>
            
            <li>
                <section>
                    <h3>Sección 6 - Enlaces a sitios web de terceros</h3>
            ...
            <li>
                <section>
                    <h3>Sección 7 - Plazos y modificaciones</h3>
                    <p>El funcionamiento de este sitio web es por tiempo indefinido.</p>
                    <p>La totalidad del sitio web o cada una de sus secciones podrá ser cerrada, suspendida o interrumpida unilateralmente por UNLu PAW, en cualquier momento y sin previo aviso.</p>
                </section>
            </li>
            
            <li>
                <section>
                    <h3>Sección 8 - Datos personales</h3>
                    <p>Durante el uso de este sitio web, ciertos datos personales serán recogidos y procesados por UNLu PAW y/o los Socios. Las normas relativas al tratamiento de los datos personales de UNLu PAW están estipuladas en la Política de Privacidad.</p>
                </section>
            </li>
            
            <li>
                <section>
                    <h3>Sección 9 - Contacto</h3>
                    <p>Si tiene alguna pregunta sobre las condiciones de uso, por favor póngase en contacto con nosotros a través de nuestro correo electrónico: tos@unlupaw.com.ar</p>
                </section>
            </li>
        </ul>
    </main>
